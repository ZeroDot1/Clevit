...
void MainWindow::on_actionNo_Theme_triggered()
{
    this->setStyleSheet("");
    ui->fontComboBox->setStyleSheet("");
    ui->fontSizeBox->setStyleSheet("");
...
void MainWindow::on_actionWood_Theme_triggered()
{
...
void MainWindow::on_actionWave_Theme_triggered()
{
...
void MainWindow::on_actionRainbow_Theme_triggered()
{
